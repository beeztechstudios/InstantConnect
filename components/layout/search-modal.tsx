    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-zinc-200 p-4">
          ...
          <button
            onClick={onClose}
            className="rounded-lg bg-zinc-100 px-3 py-1.5 text-xs font-medium text-zinc-500"
          >
            ESC
          </button>
        </div>
          ...
          {!isLoading && query && products.length > 0 && (
            <div className="p-4">
              ...
              <div className="space-y-2">
                {products.map((product) => (
                  <Link
                    ...
                    className="flex items-center gap-4 rounded-xl p-3 hover:bg-zinc-50"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-zinc-500 truncate">{product.short_description}</p>
                    </div>
              ...
              <Link
                ...
                onClick={handleProductClick}
                className="mt-4 flex items-center justify-center gap-2 rounded-lg bg-zinc-100 py-3 text-sm font-medium text-zinc-700 hover:bg-zinc-200"
              >
                View all results
                  ...
                  <div className="flex flex-wrap gap-2">
                    {recentSearches.map((search, index) => (
                      <button
                        ...
                        className="flex items-center gap-2 rounded-full bg-zinc-100 px-4 py-2 text-sm text-zinc-700 hover:bg-zinc-200"
                      >
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {categories.map((category) => (
                    <Link
                      ...
                      onClick={onClose}
                      className="flex items-center gap-3 rounded-xl bg-zinc-50 p-3 hover:bg-zinc-100 sm:p-4"
                    >
                      {category.image_url && (
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">Shop now</p>
                      </div>
                    </Link>
                  ))}
                </div>
