...
import { X, Plus, Minus, ShoppingBag, Trash2, ArrowRight, Truck, Sparkles, Tag } from 'lucide-react'
...
export function CartDrawer() {
  const { items, isOpen, closeCart, removeItem, updateQuantity, subtotal, itemCount, appliedCoupon, discountAmount, total } = useCart()
      ...
      >
        ...
        <div className="bg-white px-4 sm:px-5 py-4 safe-area-top">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={closeCart}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 hover:bg-zinc-200 active:bg-zinc-300"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
            ...
            <div className="mt-4">
              {subtotal >= FREE_SHIPPING_THRESHOLD ? (
                <div
                  ...
                  style={{ backgroundColor: 'rgba(104, 91, 199, 0.1)' }}
                >
                  <div
                  ...
                  <div>
                    <p className="text-sm font-medium" style={{ color: '#685BC7' }}>Free shipping unlocked!</p>
                    <p className="text-xs" style={{ color: '#685BC7', opacity: 0.8 }}>Your order qualifies for free delivery</p>
                  </div>
                </div>
              ) : (
                <div className="rounded-[10px] bg-zinc-100 px-4 py-3">
                  ...
                  <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-zinc-200">
                    <div
                      ...
                      style={{ width: `${shippingProgress}%`, backgroundColor: '#685BC7' }}
                    />
                  </div>
                </div>
              )}
                    ...
                    <div className="flex flex-1 flex-col min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full text-zinc-400 transition-colors hover:bg-red-50 hover:text-red-500 active:bg-red-100"
                        >
                      ...
                      <div className="mt-auto flex items-center justify-between pt-2 sm:pt-3">
                        ...
                        <div className="flex items-center rounded-full bg-zinc-100">
                          <button
                            ...
                            className="flex h-8 w-8 items-center justify-center rounded-full text-zinc-600 hover:bg-zinc-200 active:bg-zinc-300"
                          >
        ...
        {items.length > 0 && (
          <div className="bg-white px-4 sm:px-5 py-4 sm:py-5 safe-area-bottom">
            ...
            <div className="space-y-2">
              ...
              {appliedCoupon && (
                <div className="flex items-center justify-between text-sm" style={{ color: '#685BC7' }}>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span style={{ color: subtotal >= FREE_SHIPPING_THRESHOLD ? '#685BC7' : undefined }} className={subtotal >= FREE_SHIPPING_THRESHOLD ? 'font-medium' : 'text-zinc-900'}>
            ...
            <div className="mt-4 space-y-2 sm:space-y-3">
              <Link
                href="/checkout"
                onClick={closeCart}
                className="flex w-full items-center justify-center gap-2 rounded-full py-3.5 sm:py-4 text-sm font-semibold text-white active:opacity-90"
                style={{ backgroundColor: '#685BC7' }}
              >
              ...
              <Link
                href="/cart"
                onClick={closeCart}
                className="flex w-full items-center justify-center rounded-full border border-zinc-200 py-3 text-sm font-medium text-zinc-700 hover:bg-zinc-50 active:bg-zinc-100"
              >
                View Full Cart
              </Link>
            </div>
