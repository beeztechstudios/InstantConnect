...
const categories = [
  {
    ...
    cta: "Explore All",
    bgColor: "bg-[#121212]", // Deep charcoal for premium feel
    image: "/card1.png",
  },
  {
    id: 2,
    ...
    href: "/ai-review-card",
    cta: "Boost Reviews",
    bgColor: "bg-[#e61b3a]", // Matches your brand red from the screenshot
    image: "/card2.png",
  },
  {
    id: 3,
    ...
    cta: "View Designs",
    bgColor: "bg-sky-500/30", // Light contrast block
    image: "/card3.png",
    textDark: true,
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          >
            <div className="z-10 md:max-w-[240px]">
              <span className="text-sky-400/90 font-bold text-md uppercase tracking-widest">
          ...
          >
            <div className="z-10">
              <span className="text-white/60 font-medium text-md uppercase tracking-widest">
          ...
          >
            <div className="z-10">
              <span className="text-black/50 font-bold text-md uppercase tracking-widest">
          ...
          >
            <div className="z-10 md:max-w-[240px]">
              <span className="text-[#e61b3a] font-bold text-md uppercase tracking-widest">
              ...
              <div className="z-10 mt-6">
                <span className="inline-block bg-[#e61b3a] text-white px-8 py-3 rounded-xl text-sm font-bold hover:bg-red-700 transition-colors">
                  {categories[3].cta}
                </span>
              </div>
            </div>
