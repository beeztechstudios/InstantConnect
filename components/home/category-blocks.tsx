            ...
            <div className="w-[95%]">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
                    ...
                    <Link
                        ...
                        className={`group relative col-span-1 sm:col-span-2 lg:col-span-3 flex items-end overflow-hidden rounded-[10px] ${categories[0].bgColor} p-5 sm:p-8 lg:p-12 min-h-[180px] sm:min-h-[280px] lg:min-h-[400px] transition-all hover:shadow-2xl hover:shadow-indigo-500/20`}
                    >
                    ...
                    <Link
                        ...
                        className={`group relative col-span-1 lg:col-span-2 flex flex-col justify-end overflow-hidden rounded-[10px] ${categories[1].bgColor} p-5 sm:p-5 lg:p-10 min-h-[180px] sm:min-h-[220px] lg:min-h-[400px] transition-all hover:shadow-2xl hover:shadow-orange-500/20`}
                    >
                        <div
                    ...
                    <Link
                        ...
                        className={`group relative col-span-1 lg:col-span-2 flex flex-col justify-end overflow-hidden rounded-[10px] ${categories[2].bgColor} p-5 sm:p-5 lg:p-10 min-h-[180px] sm:min-h-[220px] lg:min-h-[400px] transition-all hover:shadow-2xl hover:shadow-yellow-500/20`}
                    >
                        <div
                    ...
                    <Link
                        ...
                        className={`group relative col-span-1 sm:col-span-2 lg:col-span-3 flex items-end overflow-hidden rounded-[10px] ${categories[3].bgColor} p-5 sm:p-8 lg:p-12 min-h-[180px] sm:min-h-[280px] lg:min-h-[400px] transition-all hover:shadow-2xl hover:shadow-teal-500/20`}
                    >
