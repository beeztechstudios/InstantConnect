...
import { ChevronRight, Calendar, Clock, Users, Video, Check, ArrowRight, Building2, Phone, Mail } from 'lucide-react'
        ...
        <div className="flex justify-center pt-6">
          <div className="w-[95%]">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="font-medium text-zinc-900">Book Demo</span>
            </nav>
          </div>
        </div>
        ...
        <div className="flex min-h-[70vh] items-center justify-center px-4">
          <div className="w-full max-w-md text-center">
            ...
            <p className="mt-4 text-zinc-500">
              Thank you for your interest! Our team will contact you within 24 hours to schedule your
              personalized demo.
            </p>
            <Link
              href="/shop"
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2">
              <div className="rounded-xl bg-white p-6 md:p-8">
                <h2 className="text-2xl font-bold text-zinc-900">Request Your Demo</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl bg-white p-6">
                <h3 className="font-bold text-zinc-900">What to Expect</h3>
              ...
              <div className="rounded-xl bg-gradient-to-br from-violet-600 to-violet-700 p-6 text-white">
                <p className="text-sm italic text-violet-100">
                  &quot;The demo was incredibly helpful. The team understood our needs perfectly and
                  helped us choose the right products for our entire organization.&quot;
                </p>
                <div className="mt-4 flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-white/20" />
                  <div>
                    <p className="font-medium">Priya Sharma</p>
                    <p className="text-xs text-violet-200">HR Director, TechCorp</p>
                  </div>
                </div>
              </div>
