...
export const metadata: Metadata = {
  ...
  description: 'Learn how Instant Connect collects, uses, and protects your personal information.',
}
  ...
  return (
    <div className="overflow-x-hidden" style={{ backgroundColor: '#F4F4F4' }}>
      ...
      <section className="pt-[6px] px-[6px] pb-0">
        <div className="relative h-[35vh] sm:h-[40vh] md:h-[45vh] overflow-hidden rounded-[10px]">
          ...
          <div
            ...
            style={{ backgroundImage: `url('https://images.unsplash.com/photo-1633265486064-086b219458ec?q=80&w=2070&auto=format&fit=crop')` }}
          />
      ...
      <section className="pt-6 sm:pt-8">
        <div className="mx-auto w-[95%]">
          <div className="rounded-[10px] bg-white p-5 sm:p-6 lg:p-8">
            <h2 className="text-lg sm:text-xl font-bold text-zinc-900">Introduction</h2>
            <p className="mt-3 text-sm sm:text-base text-zinc-600 leading-relaxed">
              Instant Connect (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy.
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you
              visit our website, use our products, or interact with our services. Please read this policy carefully.
        ...
        <div className="mx-auto w-[95%]">
          <div className="space-y-4 sm:space-y-6">
            {sections.map((section) => (
              <div key={section.title} className="rounded-[10px] bg-white p-5 sm:p-6 lg:p-8">
                ...
                <div className="space-y-4">
                  {section.content.map((item, index) => (
                    <div key={index}>
                      <h3 className="text-sm sm:text-base font-semibold text-zinc-900">{item.subtitle}</h3>
                      <p className="mt-1 text-xs sm:text-sm text-zinc-600 leading-relaxed">{item.text}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="pb-6 sm:pb-8">
        <div className="mx-auto w-[95%]">
          <div className="rounded-[10px] p-5 sm:p-6 lg:p-8" style={{ backgroundColor: '#685BC7' }}>
            <h2 className="text-lg sm:text-xl font-bold text-white">Cookies & Tracking</h2>
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="rounded-lg bg-white/10 p-3 sm:p-4">
                <p className="text-xs sm:text-sm font-medium text-white">Essential Cookies</p>
                <p className="mt-1 text-xs text-white/60">Required for site functionality</p>
              </div>
              <div className="rounded-lg bg-white/10 p-3 sm:p-4">
                <p className="text-xs sm:text-sm font-medium text-white">Analytics Cookies</p>
                <p className="mt-1 text-xs text-white/60">Help us improve our service</p>
              </div>
              <div className="rounded-lg bg-white/10 p-3 sm:p-4">
                <p className="text-xs sm:text-sm font-medium text-white">Marketing Cookies</p>
                <p className="mt-1 text-xs text-white/60">Used for targeted advertising</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto w-[95%]">
          <div className="rounded-[10px] p-5 sm:p-8 lg:p-10 text-center" style={{ backgroundColor: '#F5A623' }}>
            ...
            <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                href="mailto:privacy@instantconnect.in"
