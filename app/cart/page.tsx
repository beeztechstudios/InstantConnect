...
import { Minus, Plus, Trash2, ShoppingBag, ArrowRight, Tag, Home } from 'lucide-react'
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F4F4F4' }}>
      ...
      <div className="pt-20 sm:pt-28 lg:pt-36 pb-4 sm:pb-6">
        <div className="mx-auto w-[95%]">
          ...
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-zinc-900">Shopping Cart</h1>
        ...
        <div className="mx-auto w-[95%]">
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 space-y-3 sm:space-y-4">
              {items.map((item) => (
                <div key={item.productId} className="flex gap-3 sm:gap-4 rounded-[10px] bg-white p-3 sm:p-4">
                  {/* Product Image */}
                  <Link href={`/product/${item.slug}`} className="relative h-20 w-20 sm:h-28 sm:w-28 flex-shrink-0 overflow-hidden rounded-[10px] bg-zinc-100">
                    <Image
                  ...
                  <div className="flex flex-1 flex-col min-w-0">
                    <div className="flex justify-between gap-2">
                      <div className="min-w-0">
                        <Link href={`/product/${item.slug}`} className="font-medium text-sm sm:text-base text-zinc-900 hover:text-zinc-700 line-clamp-2">
                          {item.name}
                        </Link>
                      ...
                      <button
                        ...
                        className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full text-zinc-400 hover:bg-red-50 hover:text-red-500 active:bg-red-100"
                      >
            ...
            <div className="hidden sm:block lg:col-span-1">
              <div className="sticky top-24 rounded-[10px] bg-white p-4 sm:p-6">
                  ...
                  {appliedCoupon ? (
                    <div className="mt-2 flex items-center justify-between rounded-[10px] px-4 py-3" style={{ backgroundColor: 'rgba(104, 91, 199, 0.1)' }}>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium" style={{ color: '#685BC7' }}>
                          {appliedCoupon.code}
                        </span>
                      </div>
                      <button
                ...
                <Link
                  href="/checkout"
                  className="mt-5 flex w-full items-center justify-center gap-2 rounded-full py-3.5 text-sm font-semibold text-white"
                  style={{ backgroundColor: '#685BC7' }}
                >
                  Proceed to Checkout
                ...
                <Link
                  href="/shop"
                  className="mt-3 flex w-full items-center justify-center rounded-full border border-zinc-200 py-3 text-sm font-medium text-zinc-700 hover:bg-zinc-50"
                >
                  Continue Shopping
                </Link>
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-zinc-200 p-4 sm:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-between mb-3">
          ...
          {appliedCoupon && (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium" style={{ backgroundColor: 'rgba(104, 91, 199, 0.1)', color: '#685BC7' }}>
        ...
        <Link
          href="/checkout"
          className="flex w-full items-center justify-center gap-2 rounded-full py-3.5 text-sm font-semibold text-white active:opacity-90"
          style={{ backgroundColor: '#685BC7' }}
        >
